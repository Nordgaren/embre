...
/// # Fields
///
/// * `category_id`: category ID of the resource in a PE file.
/// * `resource_id`: resource ID of the resource in a PE file.
/// * `resource_name`: name of the resource to be written to disk for embedding.
/// * `pad_range`: range of randomly generated bytes between resources.
///
/// returns: BuildConfig
///
/// # Examples
...
/// // These also happen to be the default values for BuildConfig::default();
